...
Plots::Plots(QWidget *parent): QMainWindow(parent) {
    ui->setupUi(this);
    setupPlot();
...
void Plots::horzScrollBarChanged(int value)
{
...
void Plots::vertScrollBarChanged(int value)
{
...
void Plots::xAxisChanged(QCPRange range)
{
    ui->horizontalScrollBar->setValue(qRound(range.center()*100.0)); // adjust position of scroll bar slider
    ui->horizontalScrollBar->setPageStep(qRound(range.size()*100.0)); // adjust size of scroll bar slider
}

void Plots::yAxisChanged(QCPRange range)
{
